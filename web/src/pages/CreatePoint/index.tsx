...
// array ou objeto: manualmente definir o tipo da variavel
...
const CreatePoint = () => {
    ...
    // carrega cidades de acordo UF da API IBGE
    useEffect(() => {
        if (selectedUF === '0') {
            return;
        }
    ...
    // guarda coordenada clicadas no mapa
    ...
    function handleSubmit(event: FormEvent) {
        ...
        api.post('points', data).then(response => {console.log(response)});
        console.log(data);
        alert('funcionou');
        history.push('/');
    }
    ...
    return (
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                <h1>Cadastro do <br /> ponto de coletar</h1>
                {/* dados */}
                <fieldset>
